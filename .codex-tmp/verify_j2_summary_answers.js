...
const generatorPath = 'data/practice-generators/j2.js';
...
if (!keys.length) throw new Error('no j2 configs registered');
...
for (const key of keys) {
  ...
  if (config.__generatorFingerprint !== 'j2-bundle-v20260706-summary-v1') {
...
console.log(`verified summaryAnswers for ${keys.length} j2 configs`);
