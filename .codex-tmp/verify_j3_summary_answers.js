...
if (!keys.length) throw new Error('no j3 configs registered');
...
for (const key of keys) {
  ...
  if (config.__generatorFingerprint !== 'j3-bundle-v20260706-summary-v1') {
...
console.log(`verified summaryAnswers for ${keys.length} j3 configs`);
