...
const generatorPath = 'data/practice-generators/j5.js';
...
if (!keys.length) throw new Error('no j5 configs registered');

for (const key of keys) {
  if (process.env.VERBOSE_J5_VERIFY === '1') {
  ...
  if (config.__generatorFingerprint !== 'j5-bundle-v20260706-summary-v1') {
...
console.log(`verified summaryAnswers for ${keys.length} j5 configs`);
