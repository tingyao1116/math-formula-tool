...
const generatorPath = 'data/practice-generators/j6.js';
...
if (!keys.length) throw new Error('no j6 configs registered');

for (const key of keys) {
  if (process.env.VERBOSE_J6_VERIFY === '1') {
  ...
  if (config.__generatorFingerprint !== 'j6-bundle-v20260706-summary-v1') {
...
console.log(`verified summaryAnswers for ${keys.length} j6 configs`);
