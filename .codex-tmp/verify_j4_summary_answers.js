...
const generatorPath = 'data/practice-generators/j4.js';
...
if (!keys.length) throw new Error('no j4 configs registered');
...
for (const key of keys) {
  ...
  if (config.__generatorFingerprint !== 'j4-bundle-v20260706-summary-v1') {
...
console.log(`verified summaryAnswers for ${keys.length} j4 configs`);
