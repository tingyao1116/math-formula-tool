...
if (!keys.length) throw new Error('no j1 configs registered');
...
for (const key of keys) {
  ...
  if (config.__generatorFingerprint !== 'j1-bundle-v20260706-summary-v1') {
...
console.log(`verified summaryAnswers for ${keys.length} j1 configs`);
