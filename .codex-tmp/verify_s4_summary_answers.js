...
const generatorPath = 'data/practice-generators/s4.js';
...
if (!keys.length) throw new Error('no s4 configs registered');
...
for (const key of keys) {
  ...
  if (config.__generatorFingerprint !== 's4-bundle-v20260706-summary-v1') {
...
console.log(`verified summaryAnswers for ${keys.length} s4 configs`);
