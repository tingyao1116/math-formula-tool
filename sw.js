const CACHE_NAME = "math-formula-tool-v232";
const ASSETS = [
  "./",
  "./index.html",
  "./structure-view.html",
  ...
  "./data/practice-learning-architecture.js",
  "./data/practice-learning-architecture-v3.js",
  "./data/practice-learning-architecture-v4.js",
  "./data/practice-learning-architecture-v5.js",
  "./data/practice-learning-architecture-v6.js",
  "./data/practice-learning-architecture-v7.js",
  "./data/practice-ability-map.js",
  "./data/practice-skill-tree.js",
  "./formula-data.js",
  "./formula-core.js",
  "./app.js",
  "./formula-detail.js",
