...
def main():
    parser = argparse.ArgumentParser(description="Build s1-1-5 question pack from extracted markdown.")
    parser.add_argument("--markdown", required=True)
    parser.add_argument("--chapter-code", default="s1-1-5")
    parser.add_argument("--source-ref", default="source/1-5轉.docx")
